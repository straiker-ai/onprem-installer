...
DEFAULT_INSTALLER_VERSION="${STRAIKER_DEFAULT_INSTALLER_VERSION:-__STRAIKER_INSTALLER_DEFAULT_VERSION__}"
DEFAULT_INSTALLER_BUNDLE_URL="${STRAIKER_DEFAULT_INSTALLER_BUNDLE_URL:-__STRAIKER_INSTALLER_DEFAULT_BUNDLE_URL__}"
