...
declare -a ALL_PHASES=("eks-tfbe" "eks-cluster" "karpenter" "k8s-preflight" "aws-artifacts" "artifacts-sync" "straiker-system-helm")
...
EOF
  ...
  log "Config in use: aws_profile=${AWS_PROFILE_OPT:-<default>} aws_region=${AWS_REGION} install_eks=${INSTALL_EKS} cluster_name=${CLUSTER_NAME} products=${PRODUCTS_OPT:-<none>} straiker_credential_file=${STRAIKER_CREDENTIAL_FILE}"
}
