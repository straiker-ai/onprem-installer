...
declare -a ALL_RELEASES=("straiker-core" "inference-antman" "inference-hulk" "inference-quicksilver" "inference-thor" "inference-vision" "inference-wanda" "inference-thanos" "straiker-defend" "straiker-system" "straiker-artifact")
