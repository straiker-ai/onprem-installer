...
DEFAULT_NAMESPACE="straiker-system"
...
Options:
  ...
  --namespace <name>             Namespace to uninstall from (default: straiker-system).
  --release <name>               Helm release name (default: straiker-system).
